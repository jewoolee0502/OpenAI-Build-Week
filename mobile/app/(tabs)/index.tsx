...
import { ActionButton, ErrorBanner, LoadingPill } from '@/components/ui';
        ...
        <View style={styles.content}>
          <View style={[styles.playgroundHero, { height: heroHeight, paddingHorizontal: width < 390 ? 20 : 35 }]}>
            ...
            <View style={styles.heroCopy}>
              <Text adjustsFontSizeToFit numberOfLines={3} style={[styles.heroTitle, compactHero ? styles.heroTitleCompact : null]}>
          ...
          {featuredProject ? (
            ...
            <View style={styles.homeHint}>
              <Text style={styles.homeHintSpark}>✦</Text>
              <View style={styles.homeHintCopy}>
                <Text style={styles.homeHintTitle}>Your first world starts here.</Text>
                <Text style={styles.homeHintBody}>Hold Milo, share an idea, then draw the world and pieces yourself.</Text>
              </View>
            </View>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  heroCopy: { width: '100%', alignItems: 'center', paddingHorizontal: 8 },
  heroTitle: { width: '100%', color: '#111638', fontSize: 45, fontWeight: '900', letterSpacing: -2.3, lineHeight: 44, textAlign: 'center', textShadowColor: '#FFFFFF50', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 0 },
  heroTitleCompact: { fontSize: 40, letterSpacing: -2, lineHeight: 40 },
  ...
  homeHint: { minHeight: 96, flexDirection: 'row', alignItems: 'center', gap: 13, borderWidth: 1, borderColor: '#8D6BE250', borderRadius: 22, backgroundColor: '#211A42', padding: 16 },
  homeHintSpark: { color: colors.mint, fontSize: 32, fontWeight: '900' },
  homeHintCopy: { flex: 1, gap: 3 },
  homeHintTitle: { color: colors.white, fontSize: 17, fontWeight: '900' },
  homeHintBody: { color: colors.softText, fontSize: 12, lineHeight: 18 },
